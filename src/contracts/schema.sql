...
CREATE TABLE IF NOT EXISTS workers (
    ...
    tier_pinned    INTEGER NOT NULL DEFAULT 0,  -- 1 once an admin sets the tier via POST /workers/{id}/tier; a pinned tier is authoritative and attestation-derived tiering must NOT override it
