...
> **Validate transport on the real LAN early.** Plain HTTPS long-poll is the safe choice; gRPC (HTTP/2) and WebSocket upgrades get blocked by some corporate middleboxes — keep those as roadmap upgrades.
