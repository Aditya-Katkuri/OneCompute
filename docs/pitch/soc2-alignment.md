...
| TSC point | OneCompute control | Status | Citation | Gap / note |
|---|---|---|---|---|
| CC8.1 Authorized changes only | Frozen data contracts and SQLite schema treated as deliberate seams; tests mirror source layout | **Implemented** | `src/contracts/models.py`, `src/contracts/schema.sql`; `tests/` | 370 tests, 2 skipped (Docker-only) |
